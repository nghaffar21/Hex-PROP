...
public class SHexMachine {
    ...
    public static void main(String[] args) {
        ...
        SHexMachine game = new SHexMachine(player1, player2, 9, 5/*s timeout*/, 10/*games*/);
    ...
    //=====================================================================================0
    public SHexMachine(IPlayer p1, IPlayer p2, int size, int timeout, int gameCount) {
        this.size = size;
    ...
    private PlayerType play(IPlayer player, IPlayer player0) {
        ...
        while (!this.status.isGameOver()) {
            ...
            Thread t2 = new Thread(() -> {
                try {
                    Thread.sleep(SHexMachine.this.timeout * 1000);
